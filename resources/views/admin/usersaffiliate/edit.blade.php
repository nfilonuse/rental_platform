...
@section('content')
	...
	<div class="row amc-edit-form">
		<div class="col-md-12">
			...
			@endif
			{!!Form::open(array('url' => route('admin.usersaffiliate.edit_post',$item->id), 'method' => 'post', "enctype" => "multipart/form-data"))!!}
			...
			<div class="amc-field-cont">
				...
				<div class="amc-field-cont">
				{{Form::text('commission_car', number_format($item->useraffiliate->commission_car,2), array('placeholder' => 'Commission %','class' => 'form-control'))}}
		    </div>
				<div class="amc-field-cont">
				{{Form::text('referral_id', $item->useraffiliate->referral_id, array('placeholder' => 'Referral ID','class' => 'form-control'))}}
		    </div>
			<div class="row">
