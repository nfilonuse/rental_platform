...
@section('title', 'Edit dor - '.$item->name)
@section('content')
	...
	<div class="row amc-edit-form">
		<div class="col-md-12">
			...
			@endif
			{!!Form::open(array('url' => route('admin.cardors.edit_post',$item->id), 'method' => 'post', "enctype" => "multipart/form-data"))!!}
			...
			<div class="row">
				<div class="col-xs-12 col-md-12 text-center">
					...
					<a href="{{route('admin.cardors.index')}}" class="btn btn-danger">Cancel</a>
					 <div class="clear"></div>
				</div>
			</div>
			{{ Form::close() }}
