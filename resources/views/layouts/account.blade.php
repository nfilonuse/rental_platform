			    ...
			    <div class="right-buttons">
			        ...
			        @else
			   			...
			   			@if(in_array(Auth::User()->role_id,[1,2]))
				   			<a href="{{ route('admin.index') }}" class="login-button amc-account">Admin</a>
			   			@endif
    ...
    <!-- MOBILE MENU -->
		    	<div class="mobile-menu">
			        ...
			        @else
			   			...
			   			@if(in_array(Auth::User()->role_id,[1,2]))
				   			<li><a href="{{ route('admin.index') }}" class="login-button amc-account">Admin</a></li>
			   			@endif
			            ...
			            <ul class="ap-nav">
							...
							<li  class="ap-first">
								...
								<ul>
									...
									<li>
										<a href="/account/my-billing-info">EDIT ACCOUNT/BILLING INFO</a>
									</li>
								</ul>
							</li>
			                <!-- / 1 -->
							...
							<li>
								<a href="#">Affiliate</a>
								<ul>
									<li><a href="/affiliate/my-cars-booked">Cars Booked</a></li>
									<li><a href="/affiliate/my-link">My Link</a></li>
								</ul>
							</li>
							@endif
			                <!-- / 2 -->
							...
							<li>
								<a href="#">Hotels</a>
								<ul>
									<li><a href="/coming-soon">Markup percentage</a></li>
									<li><a href="/coming-soon">View Reservation</a></li>
			                        <li><a href="/coming-soon">View HB Reservation</a></li>
			                        <li><a href="/coming-soon">Cancel Reservation</a></li>
								</ul>
							</li>
			                <!-- / 3 -->
			                <!-- 4 --
